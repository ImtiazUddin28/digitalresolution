  ...
  return (
    ...
    <div className="pt-6 lg:pt-24 py-5 px-4 lg:px-0`">
      ...
      <img
        ...
        />
       <div className={index % 2 == 0 ? 'mr-3 order-last lg:order-first lg:mr-20' : 'lg:ml-20'}>
        
       <h1 className="font-[700] text-[24px] lg:text-[36px] font-[bold] leading-10  text-black py-4 lg:py-0 mt-4 lg:mt-0">
       {title} 
        </h1>
        <p className="py-4 font-[400] text-[16px] leading-6 text-[#5D647F]">{category} {sub_title}</p>
        <p className="font-[400] text-[16px] leading-8 text-[#21293C]
    text-justify">
       {content}
        </p>
