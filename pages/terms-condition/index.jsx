...
const TermsCondition = () => {
    return (
      <Layout pageTitle="Softex Solution | Terms and Condition">
        <div className="container my-6">
          <div className="py-3">
            <h1 className="font-bold text-blue-600 text-xl py-3">
              Terms & Conditions of Softex Solution
            </h1>
            <p>
              Please read these Terms & Conditions carefully before using our
              website Softex Solution or Website. By accessing or using the
          ...
          <div className="py-3">
            ...
            <p>
              Softex Solution is an IT website designed to provide software
              solutions to businesses and individuals. The content and services
              provided on the Website are for informational and non-commercial
              purposes only
            </p>
          </div>
          <div className="py-3">
          ...
          <div className="py-3">
            ...
            <p>
              ...
              property of Softex Solution or its licensors and are protected by
          ...
          <div className="py-3">
            ...
            <p>
              Softex Solution shall not be liable for any damages whatsoever
          ...
          <div className="py-3">
            ...
            <p>
              You agree to indemnify and hold harmless Softex Solution and its
          ...
          <div className="py-3">
            ...
            <p>
              Softex Solution reserves the right to modify these Terms &
              Conditions at any time without notice. Your continued use of the
              Website after any such modifications shall constitute your
          ...
          <div className="py-3">
            ...
            <p>
              Softex Solution may terminate or suspend your access to the
              Website at any time, with or without cause, and without notice
            </p>
          </div>
          <div className="py-3">
            <h1 className="font-bold text-blue-600 text-xl py-3">
            ...
            <p>
              ...
              you and Softex Solution regarding the use of the Website,
              superseding any prior agreements between you and Softex Solution.
            </p>
          </div>
        </div>
      </Layout>
